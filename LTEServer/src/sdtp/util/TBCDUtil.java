...
/**
 * This sample code demonstrates how a character string can be convered to a
 * TBCD (Telephony Binary Coded Decimal) string and vice versa.
 */
...
public class TBCDUtil {
	...
	public static java.lang.String toTBCD(byte[] tbcd) {
		...
		for (int i = 0; i < size; ++i) {
			...
			if (n1 == 15) {
				throw new NumberFormatException("Illegal filler in octet n="
						+ i);
			}
